...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://job.jayatalent.com/og.png?v=2" },
      { property: "og:image:secure_url", content: "https://job.jayatalent.com/og.png?v=2" },
      ...
      { name: "twitter:image", content: "https://job.jayatalent.com/og.png?v=2" },
    ],
    links: [
